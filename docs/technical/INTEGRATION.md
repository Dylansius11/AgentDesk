...
| I4 | ERC-8183 escrow jobs | Trustless hire: pay on attested completion | B | 🟡 (wired, live-untested — blocked on real `$U` funding, verified hard-gated, see below) | Functionality + Altana bonus |
